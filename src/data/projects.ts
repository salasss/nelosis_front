...
// SVG imports (default export is URL usually, or Component depending on config)
// Assuming default export is image URL/metadata for SVGs imported as assets
...
const projects: Project[] = [
    {
        ...
        description: "Une approche innovante pour l'agriculture urbaine autonome.",
        category: "Écologie",
        color: "#C7C652",
        icon: "leaf",
        logo: vegetallImg,
        link: "/programs/vegetall",
        size: "large",
        content: [
            {
    ...
    },
    {
        ...
        description: "Un dispositif flottant vivant pour relancer la chaîne alimentaire locale.",
        category: "Innovation",
        color: "#5CC796",
        icon: "life-buoy",
        logo: boueeImg,
        link: "/programs/bouee-vegetale",
        size: "normal",
        content: [
            {
                title: "Le concept",
    ...
    },
    {
        ...
        description: "Des briques écologiques fabriquées à base de champignons.",
        category: "Tech",
        color: "#FBA824",
        icon: "cube",
        logo: briqueImg,
        link: "/programs/brique-mycelium",
        size: "tall",
        content: [
            {
    ...
    },
    {
        ...
        description: "Sensibilisation à l'écologie pour les élèves de primaire et collège.",
        category: "Campus",
        color: "#FF7D7D",
        icon: "school",
        logo: ecoleogieImg,
        link: "/programs/ecoleogie",
        size: "normal",
        content: [
            {
                title: "Transmission",
    ...
    },
    {
        ...
        description: "Une nouvelle initiative révolutionnaire est en cours de préparation.",
        category: "À venir",
        color: "#6b7280",
        icon: "hourglass",
        link: "#",
    ...
    },
    {
        ...
        description: "Nous travaillons sur la prochaine grande étape du réseau Nélosis.",
        category: "À venir",
        color: "#6b7280",
        icon: "lock",
        link: "#",
